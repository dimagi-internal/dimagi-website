...
LABEL = {
    ...
    # org types
    'governments':'Governments','international-ngos':'International NGOs','research-academic':'Research',
...
D = {
 ...
 41:{'sec':['mental-health'],'uc':['research-academic']},
 42:{'p':['sureadhere'],'staff':1,'sec':['infectious-disease'],'uc':['research-academic'],'th':['company-culture']},
